"""
Qualitative evaluation script for SegFormer on Apple-DMS test set.
...
Usage:
    python helpers/predict_test_samples.py \
        --run_dir runs/segformer/b5/run4 \
        --output_dir predictions/test_samples/run4 \
        --seed 42
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run SegFormer predictions on random Apple-DMS test samples"
    )
    parser.add_argument(
        "--run_dir",
        type=str,
